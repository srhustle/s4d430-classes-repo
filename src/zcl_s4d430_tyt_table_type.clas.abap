CLASS zcl_s4d430_tyt_table_type DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
**********************************************************************
*   TYPES tt_persons TYPE HASHED TABLE OF z01s_person_deep
...
CLASS ZCL_S4D430_TYT_TABLE_TYPE IMPLEMENTATION.
...
*    DATA addresses TYPE tt_addresses.
     DATA addresses TYPE    Z01T_ADDRESSES.
    addresses =
      VALUE #(
...
* Task 2
**********************************************************************
    DATA person TYPE z01s_person_deep.
...
* Task 3
**********************************************************************
    DATA persons TYPE Z01T_PERSONS.
